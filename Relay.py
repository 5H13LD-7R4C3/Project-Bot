...
class relay_server:
    ...
    def run_loop(self):
        while True:
            ...
            if condition == 'echo':
                ...
                new_echo = False
            _thread.start_new_thread(self.on_accept, (echo_sock, host, port, new_echo))
    ...
    def on_accept(self, echo_sock, host, port, new_echo):
        ...
        try:
            ...
            _thread.start_new_thread(self.handle_client, (client_sock, echo_sock, host, echo_port))
        except:
